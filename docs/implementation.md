...
What `SYSMEM` does not have yet is an allocator; its ordinals 4 and 5 fail
rather than pretend. Binding imports between modules (IRX-9) and registering
libraries (IRX-10) are the next piece.
